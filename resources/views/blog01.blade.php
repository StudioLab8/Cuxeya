	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Blog</h2><span>Últimas entradas</span>
	...
	<div class="row">
		...
		<div class="col-lg-9 col-md-8 padding-right-30">
			...
			<div class="blog-post single-post">
				...
				<!-- Img -->
				<img class="post-img" src="images\blog-01.jpg" alt="">
				...
				<div class="post-content">
					...
					<ul class="post-meta">
						<li>01 de Julio del 2020</li>
					</ul>

					<p>LinkedIn abrió su plataforma para certificar personas en cualquier habilidad, en apoyo a lo que está pasando en el mundo a causa del COVID-19.
Busca tu curso online favorito y sobre todo, gratuito.</p>

					<div class="post-quote">
						<span class="icon"></span>
						<blockquote>
							Para poder consultar los cursos gratuitos da click <a href="https://opportunity.linkedin.com/skills-for-in-demand-jobs" target="_blank">aquí</a>
						</blockquote>
					</div>
			...
			<!--<ul id="posts-nav" class="margin-top-0 margin-bottom-45">
				<li class="next-post">
					<a href="#"><span>Siguiente entreda</span>
					Ayuda a personas vulnerables</a>
				</li>
				<li class="prev-post">
					<a href="#"><span>Entrada anterior</span>
			...
			<div class="about-author">
				...
				<div class="about-description">
					<h4>Natalia Martínez</h4>
					<a href="#">nmartinez@bullbeargroup.com</a>
					<p>Coordinadora</p>
				</div>
			</div>
						...
						<div class="blog-compact-item">
							...
							<div class="blog-compact-item-content">
								<ul class="blog-post-tags">
									<li>22 agosto 2019</li>
								</ul>
								<h3>Ejercicios en cuarentena</h3>
								<p>Contenido</p>
							</div>
						</div>
					</a>
				...
				<!--<div class="col-md-6">
					<a href="#" class="blog-compact-item-container">
						<div class="blog-compact-item">
							...
							<div class="blog-compact-item-content">
								<ul class="blog-post-tags">
									<li>10 agosto 2019</li>
								</ul>
								<h3>Ayuda a homeless</h3>
								<p>Contenido.</p>
							</div>
						</div>
					</a>
	...
	<div class="col-lg-3 col-md-4">
		<div class="sidebar right">
			...
			<!-- Widget -->
			<div class="widget">
				<h3 class="margin-top-0 margin-bottom-25">Buscar en Blog</h3>
				<div class="search-blog-input">
					<div class="input"><input class="search-field" type="text" placeholder="Buscar" value=""></div>
				</div>
				<div class="clearfix"></div>
			</div>
			<!-- Widget / End -->
				...
				<ul class="widget-tabs">
					...
					<li>
						<div class="widget-content">
								...
								<a href="/LinkedIn-abrio-su-pagina-para-cursos-online-gratuitos"><img src="images\blog-01.jpg" alt=""></a>
							</div>
							
							<div class="widget-text">
								<h5><a href="/LinkedIn-abrio-su-pagina-para-cursos-online-gratuitos">LinkedIn abrió su página para cursos online gratuitos </a></h5>
								<span>01 de Julio del 2020</span>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
					...
					<!--<li>
						<div class="widget-content">
							...
							<div class="widget-text">
								<h5><a href="pages-blog-post.html">Reinventate con arte</a></h5>
								<span>Noveiembre 9, 2016</span>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>-->
					...
					<!--<li>
						<div class="widget-content">
							...
							<div class="widget-text">
								<h5><a href="pages-blog-post.html">Ayuda a homeless</a></h5>
								<span>Noviembre 12, 2016</span>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>-->
