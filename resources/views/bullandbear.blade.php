...
<!-- Basic Page Needs
================================================== -->
<title>Cuxeya - Salvando Vidas</title>
<meta charset="utf-8">
...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images\alimentobab.jpg" data-background-image="images/alimentobab.jpg" class="item mfp-gallery" title="Entregamos comidas con todas las medidas sanitarias en albergues"></a>
	<a href="images\apoyobab.jpg" data-background-image="images/apoyobab.jpg" class="item mfp-gallery" title="B&B Foundation consiste en recibir apoyo, que se verá reflejado en la ayuda a la comunidad"></a>
	<a href="images\ayudabab.jpg" data-background-image="images/ayudabab.jpg" class="item mfp-gallery" title="¡Creamos puentes de ayuda juntos!"></a>
	<a href="images\bullandbear.jpg" data-background-image="images/bullandbear.jpg" class="item mfp-gallery" title="Estamos muy contentos por la oportunidad de convivir y aprender de la vida de la mano de personas con grandes trayectorias en el Asilo Árbol de Vida."></a>
</div>
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<img class="logo-fundaciones" src="/images/logo-b&b.jpg" alt="">
					<h2>Bull & Bear Foundation <span class="listing-tag">Fundaciones</span></h2>
					<span>
			...
			<div id="listing-overview" class="listing-section">
				...
				<p>
				Bull&Bear Foundation nace en el 2016 con la iniciativa de brindar apoyo a diferentes grupos vulnerables, creando una relación cercana, que nos permita comprender sus necesidades y la forma adecuada de atenderlas.
				</p>
				
				<p>
				¿QUÉ HACEMOS?</p>
				<p>Tomamos conciencia de las áreas de oportunidad que existen en México, por lo que desempeñamos acciones con la finalidad de retribuir en nuestra sociedad, a través de la coordinación de proyectos de inclusión social, trabajando de forma independiente, y apartada de grupos ideológicos.
				</p>
				<p>MISIÓN</p>
				<p>Brindar ayuda a grupos vulnerables, como retribución a nuestra sociedad.</p>
				<p>VISIÓN</p>
				<p>Ser una fundación sólida, que cuente con la capacidad desempeñar proyectos de contribución de gran impacto.</p>
				...
				<div class="listing-links-container">
					...
					<ul class="listing-links contact-links">
						<li><a href="tel:55 4161 2253" class="listing-links"><i class="fa fa-phone"></i>  (+52) 55 4161 2253</a></li>
						<li><a href="mailto:nmartinez@bullbeargroup.com" class="listing-links"><i class="fa fa-envelope-o"></i>nmartinez@bullbeargroup.com</a>
						</li>
						<li><a href="https://bullandbear-foundation.com/" target="_blank" class="listing-links"><i class="fa fa-link"></i> bullandbear-foundation.com</a></li>
					</ul>
					<div class="clearfix"></div>

					<ul class="listing-links">
						<li><a href="https://www.facebook.com/bullandbearfoundation" target="_blank" class="listing-links-fb"><i class="fa fa-facebook-square"></i> Facebook</a></li>
						<li><a href="https://www.instagram.com/bullbearfoundation/" target="_blank" class="listing-links-ig"><i class="fa fa-instagram"></i> Instagram</a></li>
						<li><a href="https://www.youtube.com/channel/UCvHyVLlBmyLkjAdrdPzyKww" target="_blank" class="listing-links-yt"><i class="fa fa-youtube"></i> Youtbe</a></li>
					</ul>
					<div class="clearfix"></div>
			...
			<center><a href="/fundaciones" class="button">Volver a Fundaciones</a></center>
			<!-- Food Menu -->
				...
				<div class="show-more">
					<div class="pricing-list-container">
						...
						<ul>
							<li>
								<h5>1 Platillo</h5>
								<p>Ayudas a 1 persona</p>
								<span><a href="javascript: pay(55);" class="button margin-top-5">$55.00 MXN</a></span>
							</li>

							<li>
								<h5>3 Platillos</h5>
								<p>Ayudas a 3 persona</p>
								<span><a href="javascript: pay(165);" class="button margin-top-5">$165.00 MXN</a></span>
							</li>

							<li>
								<h5>5 Platillos</h5>
								<p>Ayudas a 5 persona</p>
								<span><a href="javascript: pay(275);" class="button margin-top-5">$275.00 MXN</a></span>
							</li>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div id="booking-widget-anchor" class="boxed-widget booking-widget margin-top-35">
				...
				<div class="row with-forms  margin-top-0">
					...
					<div class="col-lg-12">
						<h4>Da click en aqui para regístrarte y ser parte del proyecto</h4>
					</div>

				</div>
				
				<!-- Book Now -->
				<a href="/registro-salvando-vidas" class="button book-now fullwidth margin-top-5">¡Ayudar!</a>
				@else
				<div class="row with-forms  margin-top-0">
			...
			<div class="boxed-widget margin-top-35">
				<div class="hosted-by-title">
					<h4><span>Contacto</span> <a href="https://bullandbear-foundation.com" target="_blank">BULL & BEAR Foundation. - Natalia</a></h4>
					<a href="#" class="hosted-by-avatar"><img src="images\avatar.png" alt=""></a>
				</div>
				<ul class="listing-details-sidebar">
					<li><i class="sl sl-icon-phone"></i> (+52) 55 4161 2253</li>
					<!-- <li><i class="sl sl-icon-globe"></i> <a href="#">http://example.com</a></li> -->
					<li>nmartinez@bullbeargroup.com</li>
				</ul>

				<ul class="listing-details-sidebar social-profiles">
					<li><a href="https://facebook.com/bullandbearfoundation" target="_blank" class="facebook-profile"><i class="fa fa-facebook-square"></i> Facebook</a></li>
					<li><a href="https://instagram.com/bullandbearfoundation" target="_blank" class="instagram-profile"><i class="fa fa-instagram"></i> Instagram</a></li>
...
<script type="text/javascript">
  ...
  function pay(amount) {
    var handler = StripeCheckout.configure({
	  ...
	  locale: 'auto',
	  currency: 'mxn',
  	  description: 'Donación, salvando vidas',
    ...
    handler.open({
      name: 'Salvando Vidas',
      description: 'Un platillo de esperanza',
      amount: amount * 100
    });
  }
</script>
