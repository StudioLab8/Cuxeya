	...
	<div class="main-search-inner">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h2>
						¿Como funciona Cuxeya?
						<!-- Typed words can be configured in script settings at the bottom of this HTML file -->
						
					</h2>
					<h4>Publica tu solicitud de ayuda, negocio, servicio o necesidad en Cuxeya.Org,
						para que los interesados puedan encontrarla fácilmente.</h4>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-12">
			<h3 class="headline centered margin-top-75">
				...
				<strong class="headline-with-separator margin-top-15">1. Añadir tu publicación</strong>
				<img src="images/paso1.png">
				<span class="margin-top-15">Carga la mayor información posible,  fotos, datos, etc., añade enlaces útiles a tu sitio web o a las redes sociales, establece una dirección y horas de operación y otras informaciones que consideres pertinentes.</span>

				<strong class="headline-with-separator margin-top-15">2. Visibilidad de tu publicación</strong>
				<img src="images/paso2.png">
				<span class="margin-top-15">Tras la confirmación, tu publicación aparecerá en todo el sitio web y podrá ser buscada por los visitantes interesados. la podrás editar desde tu panel de usuario.</span>

				<strong class="headline-with-separator margin-top-15">3. Recuerda utilizar un lenguaje claro y respetuoso</strong>
				<img src="images/paso3.png">
				<span class="margin-top-15">Indica si buscas ayuda ú ofreces, una ubicación, horario, experiencia, y demás datos que consideres relevantes para tu publicación</span>
