	...
	<div class="main-search-inner">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h2>
						¡{{ $user->name }} tu cuenta ya esta activa!
		...
		<div class="col-md-12">
			...
			<div class="booking-confirmation-page">
				...
				<h3 class="margin-top-30">{{ session()->get('success') }}</h3>
  				@endif
				<!--<p>Ahora puedes crear tu primera ayuda, puedes saber más acerca de como crear tu ayuda conociendo ¿como funciona cuxeya?</p>-->
				<!--<a href="/admin" class="button margin-top-30">Crear Ayuda</a>
				<a href="/como-funciona" class="button margin-top-30">¿Como funciona?</a>-->
				<p>Ahora puedes participar en nuestros programas, donar y ayudar. por favor inicia sesión.</p>
				<a href="/todas-las-ayudas" class="button margin-top-30">Ver todas las ayudas</a>
			</div>
