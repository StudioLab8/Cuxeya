	...
	<div class="fs-inner-container content">
		...
		<section class="listings-container margin-top-30">
			...
			<div class="row fs-switcher">
				...
				<div class="col-md-6">
					<!-- Showing Results -->
					<p class="showing-results">2 resultados encontrados </p>
				</div>
			...
			<!-- Listing Item -->
				<div class="col-lg-6 col-md-6">
					<a href="/salvando-vidas" class="listing-item-container compact" data-marker-id="1">
						<div class="listing-item">
							...
							<div class="listing-item-content">
								...
								<h3>Salvando Vidas <i class="verified-icon"></i></h3>
				...
				<!-- Listing Item -->
				<div class="col-lg-6 col-md-6">
					<a href="/tejiendo-redes-libertad" class="listing-item-container compact" data-marker-id="2">
						<div class="listing-item">
							<img src="images\redes-libertad-02.jpg" alt="">
							<div class="listing-item-content">
								<h3>Tejiendo redes de libertad</h3>
								<span>Ciudad de México</span>
							</div>
						</div>
					</a>
				...
				<!-- Listing Item -->
				<div class="col-lg-6 col-md-6">
					<a href="/underdogs" class="listing-item-container compact" data-marker-id="2">
						<div class="listing-item">
							<img src="images\underdogs-01.jpg" alt="">
							<div class="listing-item-content">
								<h3>Underdogs university</h3>
								<span>Ciudad de México</span>
							</div>
						</div>
					</a>
				...
				<!-- Listing Item -->
				<div class="col-lg-6 col-md-6">
					<a href="/abriga-bebe" class="listing-item-container compact" data-marker-id="2">
						<div class="listing-item">
							<img src="images\abriga-un-bebe-01.jpg" alt="">
							<div class="listing-item-content">
								<h3>Abriga un bebé</h3>
								<span>Ciudad de México</span>
							</div>
						</div>
					</a>
				...
				<!-- Listing Item -->
				<div class="col-lg-6 col-md-6">
					<a href="/laptops" class="listing-item-container compact" data-marker-id="2">
						<div class="listing-item">
							<img src="images\laptops-01.jpg" alt="">
							<div class="listing-item-content">
								<h3>Dona una laptop con causa</h3>
								<span>Ciudad de México</span>
							</div>
						</div>
					</a>
