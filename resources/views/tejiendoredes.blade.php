...
<!-- Basic Page Needs
================================================== -->
<title>Cuxeya - Tejiendo redes de libertad</title>
<meta charset="utf-8">
...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images\redes-libertad-01.jpg" data-background-image="images/redes-libertad-01.jpg" class="item mfp-gallery" title="Tejiendo redes de libertad"></a>
	<a href="images\redes-libertad-02.jpg" data-background-image="images/redes-libertad-02.jpg" class="item mfp-gallery" title="Tejiendo redes de libertad"></a>
	<a href="images\redes-libertad-01.jpg" data-background-image="images/redes-libertad-01.jpg" class="item mfp-gallery" title="Tejiendo redes de libertad"></a>
	<a href="images\redes-libertad-02.jpg" data-background-image="images/redes-libertad-02.jpg" class="item mfp-gallery" title="Tejiendo redes de libertad"></a>
</div>
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<h2>Tejiendo redes de libertad <span class="listing-tag">Voluntariado</span></h2>
					<span>
...
Somos una organización que pretende fortalecer el proceso de reinserción social
de las personas liberadas de los Centros Penitenciarios mediante la capacitación
laboral en materia digital, acompañamiento socioemocional y vinculación a
empresas socialmente responsables.<br><br>

<b>Período de vouluntariado<br>
3 meses<br><br>
Requisitos mínimos</b><br>
Conexión a internet<br>
Computadora<br>
Disponibilidad de trabajar 5 horas al día<br>
Interés en trabajar en proyectos sociales<br><br>
<b>Número de voluntarios</b><br>
4 voluntarios por perfil<br><br>
<b>Fechas y horarios de capacitación</b><br>
Sábados de 12 a 14 pm<br><br>

<b>Perfiles de voluntarios</b><br>
Abogada(o)<br>
Programadora(o)<br>
Ingeniera(o) (talleristas de robótica)<br>
Matemática(o) (estudios en estadística aplicada)<br>
</p>
				...
				<div class="listing-links-container">
					...
					<ul class="listing-links contact-links">
						...
						<li><a href="mailto:hola@cuxeya.org" class="listing-links"><i class="fa fa-envelope-o"></i>hola@cuxeya.org</a></li>
						<li><a href="#" target="_blank" class="listing-links"><i class="fa fa-link"></i> cuxeya.org</a></li> -->
					</ul>
					<div class="clearfix"></div>

					<ul class="listing-links">
						<li><a href="https://www.facebook.com/TRLibertad" target="_blank" class="listing-links-fb"><i class="fa fa-facebook-square"></i> Facebook</a></li>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div id="booking-widget-anchor" class="boxed-widget booking-widget margin-top-35">
				...
				<!-- Book Now -->
				<a href="/registro-tejiendo-redes-libertad" class="button book-now fullwidth margin-top-5">¡Ayudar!</a>
				@else
				<div class="row with-forms  margin-top-0">
...
<script type="text/javascript">
  ...
  function pay(amount) {
    var handler = StripeCheckout.configure({
	  ...
	  locale: 'auto',
	  currency: 'mxn',
  	  description: 'Donación, tejiendo redes de libertad',
