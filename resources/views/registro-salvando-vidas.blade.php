	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Registro - Salvando Vidas, un platillo de esperanza </h2>
...
<div class="container">
    ...
    @endif
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			<form method="post" id="form-savinglives" action="{{ route('savinglives.store') }}">
			@csrf
			...
			<div class="row">
				...
				<div class="col-md-6">
					<h5>Precio del platillo</h5>
					<input type="text" value="" name="precio">
				</div>

				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<h5>¿Que incluye el platillo ó que platillo es?</h5>
						<input type="text" value="" name="platillo">
					</div>
				</div>

				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<h5>Día y hora para recoger la comida</h5>
						<input type="text" value="" name="dia_y_hora">
					</div>
				</div>

				<div class="col-md-12">
					<h5>Menú</h5>
					<textarea class="WYSIWYG" name="menu" cols="40" rows="3" id="menu" spellcheck="true"></textarea>
				</div>

			</div>
			
			@if(isset(Auth::user()->email))	
			<a href="javascript:;" id="button-form-savinglives" class="button booking-confirmation-btn margin-top-40 margin-bottom-65">Registrarme</a>
			@else
		...
		<div class="col-lg-4 col-md-4 margin-top-0 margin-bottom-60">
			...
			<div class="listing-item-container compact order-summary-widget">
				<div class="listing-item">
					<img src="images\fondas-03.png" alt="">

					<div class="listing-item-content">
						<h3>Salvando vidas</h3>
						<span>Un platillo de esperanza</span>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="{{ asset('scripts/custom/savinglives.js') }}"></script>
