...
<!-- Basic Page Needs
================================================== -->
<title>Cuxeya - Dona una laptop con causa</title>
<meta charset="utf-8">
...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images/laptops-01.jpg" data-background-image="images/laptops-01.jpg" class="item mfp-gallery" title="Dona una laptop"></a>
	<a href="images/laptops-01.jpg" data-background-image="images/laptops-01.jpg" class="item mfp-gallery" title="Dona una laptop"></a>
</div>
	...
	<div class="row sticky-wrapper">
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<h2>Dona una laptop con causa <span class="listing-tag">Objetos</span></h2>
					<span>
			...
			<div id="listing-overview" class="listing-section">
				...
				<p>
				¡Es hora de ayudar a quien más lo necesita!
				Buscamos donadores de laptops o tablets en excelente
				estado para donar a la Escuela Preparatoria Oficial
				núm. 98 en el Municipio de Chimalhuacán, Estado de
				México.<br><br>
				Si tienes una laptop o tablet que ya no utilices y que se
				encuentre en excelente estado, puedes mandarnos
				mensaje directo.<br><br>
				Recuerda: la juventud es parte de nuestro futuro
				</p>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div id="booking-widget-anchor" class="boxed-widget booking-widget margin-top-35">
				...
				<!-- Book Now -->
				<a href="/registro-laptops" class="button book-now fullwidth margin-top-5">¡Ayudar!</a>
				@else
				<div class="row with-forms  margin-top-0">
...
<script type="text/javascript">
  ...
  function pay(amount) {
    var handler = StripeCheckout.configure({
	  ...
	  locale: 'auto',
	  currency: 'mxn',
  	  description: 'Donación, Laptops con causa',
