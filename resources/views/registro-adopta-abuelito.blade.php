	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Registro - Adopta a un abuelito </h2>
...
<div class="container">
    ...
    @endif
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			<form method="post" id="form-adoptgrandpa" action="{{ route('adoptgrandpa.store') }}">
			@csrf
			...
			<h3 class="margin-top-0 margin-bottom-30">Detalles del programa <i class="tip" data-tip-content="Necesitamos esta información para dar un mejor servicio"></i></h3>

			<div class="row">

				<div class="col-md-6">
					<h5>¿Por cuánto tiempo quieres adoptarlo?</h5>
					<input type="text" value="" name="tiempo_de_adopcion">
				</div>

				<div class="col-md-6">
					<h5>¿Harás donación en especie o monetaria?</h5>
					<input type="text" value="" name="donacion_en_especio_o_monetario">
				</div>

				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<h5>¿Cada cuánto tiempo te gustaría regalarle algo al abuelito?</h5>
						<input type="text" value="" name="tiempo_de_ayuda_en_regalos">
					</div>
				</div>

				<div class="col-md-6">
					<div class="input-with-icon medium-icons">
						<h5>¿Querrás acompañarnos a la entrega o sólo querrás fotos?</h5>
						<input type="text" value="" name="visita_o_fotos">
					</div>
				</div>
			...
			<a href="javascript:;" id="button-form-adoptgrandpa" class="button booking-confirmation-btn margin-top-40 margin-bottom-65">Registrarme</a>
			@else
		...
		<div class="col-lg-4 col-md-4 margin-top-0 margin-bottom-60">
			...
			<div class="listing-item-container compact order-summary-widget">
				<div class="listing-item">
					<img src="images\abuelitos-03.jpg" alt="">

					<div class="listing-item-content">
						<h3>Ádopta a un abuelito</h3>
						<span>Árbol de vida</span>
					</div>
				</div>
			</div>
...
<script type="text/javascript" src="{{ asset('scripts/custom/adoptgrandpa.js') }}"></script>
