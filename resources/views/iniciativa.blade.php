	...
	<div class="main-search-inner">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h2>
						Iniciativa Cuxeya.org
						<!-- Typed words can be configured in script settings at the bottom of this HTML file -->
						
					</h2>
					<h4>Publica tu solicitud de ayuda, servicio o necesidad en Cuxeya.org,
	...
	<div class="row">
		...
		<div class="col-md-12">
			<h3 class="headline centered margin-top-75">
				...
				<span class="margin-top-35">Nacemos de la necesidad de unirnos como comunidad, buscamos reunir y resaltar brazos de ayuda que nos caracteriza.</span>

				<span class="margin-top-15">Contar con un sitio referente donde podamos consultar y publicar información de interés común como: Asesoría legal, fundaciones, hospedaje, cultura, echarnos la mano, buscar y ofrecer algo a la sociedad</span>

			</h3>
		</div>
		
		<div class="col-md-12 centered">
			<img src="images/ninos_manos.png"  width="600" height="400">
			<br><br><br>
		</div>
