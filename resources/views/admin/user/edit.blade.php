		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="dashboard-list-box margin-top-0">
					<h4 class="gray">Actualizar Estado</h4>
					...
					<form method="post" id="form-estate" action="{{ route('estates.update', $estate->id) }}">
            			@method('PATCH') 
            			@csrf
						<!-- Change Password -->
						<div class="row with-forms">
							<div class="col-md-6">
								<h5>Estado <i class="tip" data-tip-content="Nombre del Estado"></i></h5>
								<input type="text" name="estate" value="{{ $estate->estate }}" />
							</div>	
						</div>

						<div class="row with-forms">
							<div class="col-md-6">
								<a href="javascript:;" id="button-form-estate" class="button">Actualizar</a>
