				...
				<div id="add-listing">
					...
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								<h5>Nombre del proyecto <i class="tip" data-tip-content="Name of your business"></i></h5>
						...
						<div class="row with-forms">
							...
							<div class="col-md-6">
								...
								<select class="chosen-select-no-single">
									<option label="blank">Selecciona una categoría</option>	
							...
							<h5>Tipo de proyecto</h5>
								<select class="chosen-select-no-single">
									<option label="blank">Selecciona una tipo</option>	
									<option>Fundación</option>
									<option>Negocio/Proyecto Idenpendiente</option>
								</select>
							</div>
						...
						<div class="row with-forms">
							...
							<h5>Online ó presencial</h5>
								<select class="chosen-select-no-single">
									<option label="blank">Selecciona una modalidad</option>	
						...
						<div class="submit-section">
							...
							<div class="row with-forms">
								...
								<div class="col-md-6">
									<h5>País</h5>
									<select class="chosen-select-no-single">
										<option label="blank">Selecciona un país</option>	
							...
							<div class="row with-forms">
								...
								<div class="col-md-6">
									<h5>Dirección</h5>
									<input type="text" placeholder="e.j. 964 School Street">
								</div>
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="row with-forms">
							...
							<!-- Phone -->
							<div class="col-md-12">
								<h5>Youtube Video <span>(opcional)</span></h5>
								<textarea class="WYSIWYG" name="summary" cols="40" rows="2" id="summary" spellcheck="true"></textarea>
							</div>
