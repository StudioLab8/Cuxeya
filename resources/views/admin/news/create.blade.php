				...
				<div id="add-listing">
					...
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input id="title" class="search-field" type="text" value="">
							</div>
						</div>
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="form">
							...
							<textarea id="content" class="WYSIWYG" name="summary" cols="40" rows="3" spellcheck="true"></textarea>
						</div>

					</div>
					<!-- Section / End -->

					<a href="#" id="save-news" class="button preview">Guardar <i class="fa fa-arrow-circle-right"></i></a>
