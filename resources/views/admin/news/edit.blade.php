				...
				<div id="add-listing">
					...
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								<h5>Título <i class="tip" data-tip-content="Título de la noticia"></i></h5>
								<input id="title" class="search-field" type="text" value="{{$news->title}}">
					...
					<div class="add-listing-section margin-top-45">
						...
						<div class="submit-section">
							<form action="{{ route('dropzone.news.store') }}" enctype="multipart/form-data" class="dropzone" id="dropzone">
								@csrf
    							<div class="fallback">
						...
						<table class="basic-table">
							...
							<tr id="row-{{$image->id}}">
								<td data-label="Column 1"><img src="/images/uploads/news/{{$image->image_name}}" width="300" heigth="150"/></td>
								<td data-label="Column 2">{{$image->image_name}}</td>
								<td data-label="Column 2"><a href="javascript: delete_image({{$image->id}});" class="button gray"><i class="sl sl-icon-note"></i> Quitar</a></td>
							</tr>
							@endforeach
						</table>
					...
					<div class="add-listing-section margin-top-45">
						...
						<!-- Descripción -->
						<div class="form">
							<h5>Escribe tu noticia </h5>
							<textarea id="content" class="WYSIWYG" name="summary" cols="40" rows="3" spellcheck="true">
								{{$news->content}}
							</textarea>
						</div>
					...
					<a href="#" id="edit-news" class="button preview">Guardar <i class="fa fa-arrow-circle-right"></i></a>
...
<script type="text/javascript">
	...
	<script type="text/javascript" src="{{ asset('scripts/custom/news.js') }}"></script>
	<script type="text/javascript">
