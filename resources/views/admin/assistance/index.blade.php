							...
							<table id="table_id" class="display" style="width:100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{$assistance->curp}}</td>
											<td>{{$assistance->phone}}</td>
											<td>{{$assistance->comment}}</td>
											<!--<td><a href="{{ route('savinglives.show',$assistance->id)}}" class="button gray"><i class="sl sl-icon-note"></i> Ver</a></td>-->
											<!--<td><a href="{{ route('savinglives.show',$assistance->id)}}" class="button gray"><i class="sl sl-icon-close"></i> Delete</a></td>-->
										</tr>
										@endforeach
									</tbody>
								</table>		
