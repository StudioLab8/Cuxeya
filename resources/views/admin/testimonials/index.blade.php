			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box margin-top-0">
					...
					<div class="booking-requests-filter">
						<a href="{{ route('testimonials.create') }}" class="button">Nuevo testimonio</a>
					</div>
									...
									<tbody>
										@foreach($testimonials as $testimony)
											<tr>
												...
												<td>
												@if($testimony->activated)
													SI
												@else
													NO
												@endif
											</td>
												<td><a href="{{ route('testimonials.edit', $testimony->id)}}" class="button gray"><i class="sl sl-icon-note"></i> Editar</a></td>
											</tr>
										@endforeach
									</tbody>
								</table>		
