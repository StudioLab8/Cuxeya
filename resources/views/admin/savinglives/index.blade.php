					...
					<ul>
						...
						<li>
							...
							<table id="table_id" class="display" style="width:100%">
									...
									<tbody>
										@foreach($savinglives as $savinglive)
										<tr>
											<td>{{$savinglive->id}}</td>
											<td>{{$savinglive->first_name}}</td>
											<td>{{$savinglive->last_name}}</td>
											<td>{{$savinglive->email}}</td>
											<td>{{$savinglive->curp}}</td>
											<td><a href="{{ route('savinglives.show',$savinglive->id)}}" class="button gray"><i class="sl sl-icon-note"></i> Ver</a></td>
											<!--<td><a href="{{ route('savinglives.show',$savinglive->id)}}" class="button gray"><i class="sl sl-icon-close"></i> Delete</a></td>-->
										</tr>
										@endforeach
									</tbody>
								</table>		
