							...
							<table id="table_id" class="display" style="width:100%">
									...
									<tbody>
										...
										<tr>
											<td>{{$estate->id}}</td>
											<td>{{$estate->estate}}</td>
											<td><a href="{{ route('estates.edit',$estate->id)}}" class="button gray"><i class="sl sl-icon-note"></i> Edit</a></td>
											<td><a href="{{ route('estates.show',$estate->id)}}" class="button gray"><i class="sl sl-icon-close"></i> Delete</a></td>
										</tr>
										@endforeach
									</tbody>
								</table>		
