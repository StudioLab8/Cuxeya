...
<!-- Basic Page Needs
================================================== -->
<title>Cuxeya - Abriga un bebé</title>
<meta charset="utf-8">
...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images\abriga-un-bebe-01.jpg" data-background-image="images/abriga-un-bebe-01.jpg" class="item mfp-gallery" title="Cuxeya"></a>
	<a href="images\abriga-un-bebe-01.jpg" data-background-image="images/abriga-un-bebe-01.jpg" class="item mfp-gallery" title="Cuxeya"></a>
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<h2>Abriga un bebé <span class="listing-tag">Voluntariado</span></h2>
					<span>
			...
			<div id="listing-overview" class="listing-section">
				...
				<p>
					<b>Descripción</b><br>
					Si necesitas ropa de bebé recién nacido hasta 6 meses, llena nuestro formulario.
				</p>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div id="booking-widget-anchor" class="boxed-widget booking-widget margin-top-35">
				...
				<div class="row with-forms  margin-top-0">
					...
					<div class="col-lg-12">
						<h4>Da click para poder llenar el formulario y solicitar la ayuda.</h4>
					</div>

				</div>
				
				<!-- Book Now -->
				<a href="/registro-ropa-bebe" class="button book-now fullwidth margin-top-5">Crear Solicitud</a>
				@else
				<div class="row with-forms  margin-top-0">
...
<script type="text/javascript">
  ...
  function pay(amount) {
    var handler = StripeCheckout.configure({
	  ...
	  locale: 'auto',
	  currency: 'mxn',
  	  description: 'Donación, Abriga a un bebé',
