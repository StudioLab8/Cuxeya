...
<section class="fullwidth padding-top-75 padding-bottom-30" data-background-color="#f9f9f9">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<h3 class="headline centered headline-extra-spacing">
					<strong class="headline-with-separator">Testimonios</strong>
					<span class="margin-top-25">¡La experiencia de nuestros brazos de ayuda y personas beneficiadas!</span>
				</h3>
			</div>
		</div>
