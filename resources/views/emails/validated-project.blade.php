        ...
        <tr>
            <td style="background-color: #ecf0f1;">
                ...
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify; font-family: sans-serif;">
                    <h2 style="color: #e67e22; margin: 0 0 7px;">¡Felicidades {{ $data['user'] }} tu ayuda está publicada!</h2>
                    <p style="margin: 2px; font-size: 15px;"><span style="font-weight: bolder;">
                        Ingresa ahora a cuxeya.org para que lo puedas encontrar, también puedes compartirlo a tus redes sociales, para potencializar tu ayuda.
                    </span>
                    </p>
                </div>
