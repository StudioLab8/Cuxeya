        ...
        <tr>
            <td style="background-color: #ecf0f1;">
                ...
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify; font-family: sans-serif;">
                    <h2 style="color: #e67e22; margin: 0 0 7px;">¡Bienvenido a Cuxeya {{ $data['user'] }}!</h2>
                    <p style="margin: 2px; font-size: 15px;"><span style="font-weight: bolder;">
                        Gracias por ser parte de este proyecto, para terminar el proceso de registro y comenzar a crear tus ayudas, activa tu cuenta dando click en el enlace.
                    </span>
                    </p>
                </div>
