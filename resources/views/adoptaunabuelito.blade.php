...
<!-- Basic Page Needs
================================================== -->
<title>Cuxeya - Adopta un abuelito</title>
<meta charset="utf-8">
...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images\abuelitos-01.jpg" data-background-image="images/abuelitos-01.jpg" class="item mfp-gallery" title="Adopta un abuelito"></a>
	<a href="images\abuelitos-02.jpg" data-background-image="images/abuelitos-02.jpg" class="item mfp-gallery" title="Adopta un abuelito"></a>
	<a href="images\abuelitos-03.jpg" data-background-image="images/abuelitos-03.jpg" class="item mfp-gallery" title="Adopta un abuelito"></a>
	<a href="images\abuelitos-04.jpg" data-background-image="images/abuelitos-04.jpg" class="item mfp-gallery" title="Adopta un abuelito"></a>
	<a href="images\abuelitos-05.png" data-background-image="images/abuelitos-05.png" class="item mfp-gallery" title="Adopta un abuelito"></a>
</div>
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<h2>Adopta a un abuelito <span class="listing-tag">Voluntariado</span></h2>
					<span>
			...
			<div id="listing-overview" class="listing-section">
				...
				<p>
				El fin es que por 3 meses nos comprometamos a adoptar a un abuelito del
Asilo “Árbol de Vida”, para que semanal o quincenalmente le regales algo:
desde ropa, despensa, una carta o algo que te recuerde a él. Esto con el fin de
que no se sientan solos ni abandonados. Puedes donarlo en dinero o especie y
nosotros nos encargamos de dárselo o puedes ir con nosotros a entregarlo.
				</p>
				...
				<div class="listing-links-container">
					...
					<ul class="listing-links contact-links">
						<li><a href="tel:52 43 16 42" class="listing-links"><i class="fa fa-phone"></i> 52 43 16 42</a></li>
						<li><a href="mailto:infoasiloarboldevida@gmail.com" class="listing-links"><i class="fa fa-envelope-o"></i> infoasiloarboldevida@gmail.com</a>
						</li>
						<li><a href="https://asiloarboldevida.com" target="_blank" class="listing-links"><i class="fa fa-link"></i> asiloarboldevida.com</a></li>
					</ul>
					<div class="clearfix"></div>

					<ul class="listing-links">
						<li><a href="https://facebook.com/asiloarboldevida/" target="_blank" class="listing-links-fb"><i class="fa fa-facebook-square"></i> Facebook</a></li>
						<li><a href="https://instagram.com/asiloarboldevida18/" target="_blank" class="listing-links-ig"><i class="fa fa-instagram"></i> Instagram</a></li>
						<li><a href="https://twitter.com/asiloarboldevid" target="_blank" class="listing-links-tt"><i class="fa fa-twitter"></i> Twitter</a></li>
					</ul>
					<div class="clearfix"></div>
			...
			<div id="listing-pricing-list" class="listing-section">
				...
				<div class="show-more">
					<div class="pricing-list-container">
						...
						<ul>
							<li>
								<h5>Despensa básica</h5>
								<p>Es para dar la canasta basica.</p>
								<span><a href="javascript: pay(100);" class="button margin-top-5">$100.00 MXN</a></span>
							</li>

							<li>
								<h5>Mantenimiento de la casa hogar</h5>
								<p>Para resanar la fundación</p>
								<span><a href="javascript: pay(300);" class="button margin-top-5">$300.00 MXN</a></span>
							</li>

							<li>
								<h5>Despensa grande</h5>
								<p>Incluye canasta basica + pañales de adulto</p>
								<span><a href="javascript: pay(500);" class="button margin-top-5">$500.00 MXN</a></span>
							</li>
			...
			<div id="listing-location" class="listing-section">
				...
				<div id="singleListingMap-container">
					<div id="singleListingMap" data-latitude="19.3420841" data-longitude="-99.1577462" data-map-icon="im im-icon-Map2"></div>
		...
		<div class="col-lg-4 col-md-4 margin-top-75 sticky">
			...
			<div id="booking-widget-anchor" class="boxed-widget booking-widget margin-top-35">
				...
				<!-- Book Now -->
				<a href="/registro-adopta-abuelito" class="button book-now fullwidth margin-top-5">¡Ayudar!</a>
				@else
				<div class="row with-forms  margin-top-0">
...
<script type="text/javascript">
  ...
  function pay(amount) {
    ...
    handler.open({
      name: 'Cuxeya',
      description: 'Adopta a un abuelito',
      amount: amount * 100
    });
  }
</script>
