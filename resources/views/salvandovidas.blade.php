...
<div class="listing-slider mfp-gallery-container margin-bottom-0">
	<a href="images\fondas-01.png" data-background-image="images/fondas-01.png" class="item mfp-gallery" title="Salvando vidas, un platillo de esperanza"></a>
	<a href="images\fondas-02.png" data-background-image="images/fondas-02.png" class="item mfp-gallery" title="Salvando vidas, un platillo de esperanza"></a>
	<a href="images\fondas-03.png" data-background-image="images/fondas-03.png" class="item mfp-gallery" title="Salvando vidas, un platillo de esperanza"></a>
	<a href="images\fondas-04.png" data-background-image="images/fondas-04.png" class="item mfp-gallery" title="Salvando vidas, un platillo de esperanza"></a>
</div>
		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="titlebar" class="listing-titlebar">
				<div class="listing-titlebar-title">
					<h2>Salvando vidas, un platillo de esperanza <span class="listing-tag">Alimentos</span></h2>
					<span>
			...
			<div id="listing-overview" class="listing-section">
				...
				<p>
				Sabemos que tras el COVID-19, el 15% de los
negocios de comida ya no reabrirán, por eso compraremos comida a las
fondas, para repartirla a gente en situación de calle y personal médico, en la
zona centro de la CDMX.
				</p>
				
				<p>
				¿Cómo puedes ayudar? <br>
				1) Si eres local de comida, puedes darnos un precio más accesible de tus platillos. Así nosotros te apoyamos en tus ventas y tú apoyas a que este proyecto se cumpla.
				</p>

				<p>
				2) Si eres persona, puedes donar a la cuenta: <br />
				    BBVA <br />
					FUNDACION BULL &amp; BEAR AC <br />
					Cuenta: 0110808466 <br />
					Clabe: 012180001108084660 <br />
					</p>
				</p>
				...
				<div class="listing-links-container">
					...
					<ul class="listing-links contact-links">
						<li><a href="tel: 52 6729 8386" class="listing-links"><i class="fa fa-phone"></i>  (+52) 6729 8386</a></li>
						...
						<li><a href="#" target="_blank" class="listing-links"><i class="fa fa-link"></i> cuxeya.org</a></li>
					</ul>
					<div class="clearfix"></div>

					<ul class="listing-links">
						<li><a href="https://facebook.com/cuxeyaorg" target="_blank" class="listing-links-fb"><i class="fa fa-facebook-square"></i> Facebook</a></li>
						<li><a href="https://instagram.com/cuxeya" target="_blank" class="listing-links-ig"><i class="fa fa-instagram"></i> Instagram</a></li>
						<li><a href="https://twitter.com/cuxeya" target="_blank" class="listing-links-tt"><i class="fa fa-twitter"></i> Twitter</a></li>
					</ul>
					<div class="clearfix"></div>
