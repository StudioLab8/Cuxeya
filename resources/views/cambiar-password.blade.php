...
<div class="container centered">
	<div class="row">
		...
		<div class="col-md-5 centered">
			...
			<form method="post" action="{{ url('changeConfirmPassword') }}" name="contactform">
			@csrf
			<input class="input-text" type="hidden" name="id" id="id" value="{{$user->id}}">

			<p class="form-row form-row-wide">
				<label for="password1">Nueva Contraseña:
					<i class="im im-icon-Lock-2"></i>
			...
			<p class="form-row form-row-wide">
				<label for="password2">Confirmar nueva contraseña:
					<i class="im im-icon-Lock-2"></i>
					<input class="input-text" type="password" name="password_confirmation" id="password2">
				</label>
			</p>

			<input type="submit" class="button border fw margin-top-10" name="register-button" id="register-button" value="Cambiar mi contraseña">
			</form>		
