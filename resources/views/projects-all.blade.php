										...
										<div class="panel-dropdown-content checkboxes categories">
											...
											<div class="row">
												<div class="col-md-6">
													...
													<label for="check-2">Adopción</label>

													<input id="check-3" type="checkbox" name="check">
													<label for="check-3">Asesoría</label>
												</div>	

												<div class="col-md-6">
													<input id="check-4" type="checkbox" name="check">
													<label for="check-4">Alimentos</label>

													<input id="check-5" type="checkbox" name="check">
													<label for="check-5">Educación</label>	

													<input id="check-6" type="checkbox" name="check">
													<label for="check-6">Objetos</label>

													<input id="check-6" type="checkbox" name="check">
													<label for="check-6">Salud</label>

													<input id="check-6" type="checkbox" name="check">
													<label for="check-6">Albergues</label>

													<input id="check-6" type="checkbox" name="check">
													<label for="check-6">Voluntariado</label>
												</div>
											</div>
		...
		<section class="listings-container margin-top-30">
			...
			@foreach($projects as $project)
				...
				<div class="col-lg-6 col-md-6">
					<a href="/proyecto/{{$project->url}}" class="listing-item-container compact" data-marker-id="1">
						<div class="listing-item">
							<img src="/images/uploads/{{$project->gallery->first()->image_name}}" alt="">

							<div class="listing-item-content">
								<h3>{{$project->name}} <i class="verified-icon"></i></h3>
							</div>
			...
			<div class="row fs-listings">
				<div class="col-md-12">
					...
					<!-- Copyrights -->
					<div class="copyrights margin-top-0">© 2021 Cuxeya.org</div>
